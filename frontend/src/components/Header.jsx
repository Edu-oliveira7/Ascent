...
export default function Header() {
  ...
  return (
    <>
      <header 
        ...
        <div className="max-w-[1280px] w-full mx-auto px-6 md:px-12 flex items-center justify-between relative">
          ...
          <div className="flex items-center gap-6">
            <button onClick={(e) => scrollTo(e, "#sobre")} className="hidden md:block font-['Barlow'] text-[0.7rem] font-bold tracking-[0.2em] uppercase text-white border border-white/20 px-6 py-2.5 hover:border-[#ff301d] hover:bg-[#ff301d]/10 transition-all duration-300">
              Acessar
            </button>
      ...
      {/* Mobile Drawer */}
      <div className={`fixed inset-0 z-[900] bg-[#0a0a0a] flex flex-col items-center justify-center gap-10 transition-transform duration-700 ease-[cubic-bezier(0.77,0,0.175,1)] ${
